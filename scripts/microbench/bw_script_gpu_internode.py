...
def main():
    ...
    mpi4py_small._output_f = open(f'{output_base}/mpi4py_internode_gpu_bw.csv', 'w')
    ...
    charm4py_small._output_f = open(f'{output_base}/charm4py_internode_gpu_bw.csv', 'w')
    charm4py_large._output_f = charm4py_small._output_f

    charm_inter = jsrun.bake(*charm_cmd, *charm_args)
    charm_inter._output_f = open(f'{output_base}/charm_internode_gpu_bw.csv', 'w')

    mpi_inter = mpirun.bake(*mpirun_args, *mpi_cmd)
    mpi_inter._output_f = open(f'{output_base}/mpi_internode_gpu_bw.csv', 'w')
